    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button className="p-4 bg-gradient-to-br from-primary/10 to-primary-dark/10 rounded-xl hover:shadow-md transition-all text-center">
          ...
          <button className="p-4 bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl hover:shadow-md transition-all text-center">
